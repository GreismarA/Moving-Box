import "../resources/styles/newBoxForm.css"
...
const NewBoxForm = () => {
  ...
  return (
    <>
      <div className="bg-white pt-16 p-20" >
        <h2 className="font-[900] text-[40px] mb-4 text-black text-center">Formulario</h2>
        <div className="bg-black w-full py-8 px-6 rounded-2xl">
          <form className="lg:grid lg:grid-cols-2 gap-20">
              ...
              <div>
                <div className="flex flex-col gap-y-5c mb-4 " >
                  ...
                  <input className=" mb-4 border-b border-white bg-black caret-white text-white border-solid outline-none p-[4px]"
                    ...
                    onKeyUp={handleEnter}
                  />
                  <div className='flex m-auto w-1/5'><button type="button" className="py-3 px-8 rounded font-medium bg-[#e2e756] hover:bg-[#f5f89f]" onClick={handleOnChangeAdd}>agregar</button></div>
            ...
            <div>
              ...
              <div className='flex m-auto w-1/5'><button className="py-3 px-8 rounded font-medium bg-[#e2e756] hover:bg-[#f5f89f]" type="submit" onClick={handleSubmit}>
                Submit
              </button></div>
              <div className="mt-10">
